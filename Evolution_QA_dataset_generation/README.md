...
├── training_logs/                   # W&B exported training curves
│   ├── train_loss_square.png
│   ├── eval_loss_sq.png
│   ├── learning_rate_sq.png
│   └── grad_norm_sq.png
└── README.md
```
...
<p align="center">
  <img src="Evolution_QA_dataset_generation/diagrams/generator.svg" alt="Evolutionary Generator Workflow" width="700"/>
</p>

The high-level data flow follows this sequence:

<p align="center">
  <img src="Evolution_QA_dataset_generation/navigator_agent_augment_data_flow.png" alt="Navigator Agent Data Flow" width="700"/>
</p>
...
#### Training Loss
<p align="center">
  <img src="training_logs/train_loss_square.png" alt="Training Loss" width="500"/>
</p>
...
#### Evaluation Loss
<p align="center">
  <img src="training_logs/eval_loss_sq.png" alt="Evaluation Loss" width="500"/>
</p>
...
<p align="center">
  <img src="training_logs/learning_rate_sq.png" alt="Learning Rate" width="500"/>
</p>
...
#### Gradient Norm
<p align="center">
  <img src="training_logs/grad_norm_sq.png" alt="Gradient Norm" width="500"/>
</p>
...
<p align="center">
  <img src="Evolution_QA_dataset_generation/diagrams/evaluated_metric_results.png" alt="Evaluation Results" width="700"/>
</p>
